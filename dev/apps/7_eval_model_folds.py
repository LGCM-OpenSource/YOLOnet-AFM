...
predicts_dict = {'vUnet_AFM': f'data{os.sep}output{os.sep}vunet_AFM_predictions{os.sep}predict_sheets{os.sep}',
                 'Unet_AFM':  [
                               f'data{os.sep}output{os.sep}unet_AFM_predictions{os.sep}predict_sheets{os.sep}',
                               f'data{os.sep}output{os.sep}unet_AFM_predictions2{os.sep}predict_sheets{os.sep}',
                               f'data{os.sep}output{os.sep}unet_AFM_predictions3{os.sep}predict_sheets{os.sep}',
                               f'data{os.sep}output{os.sep}unet_AFM_predictions4{os.sep}predict_sheets{os.sep}',
                               f'data{os.sep}output{os.sep}unet_AFM_predictions5{os.sep}predict_sheets{os.sep}',
                               f'data{os.sep}output{os.sep}unet_AFM_predictions6{os.sep}predict_sheets{os.sep}',
                               f'data{os.sep}output{os.sep}unet_AFM_predictions7{os.sep}predict_sheets{os.sep}',
                               f'data{os.sep}output{os.sep}unet_AFM_predictions8{os.sep}predict_sheets{os.sep}',
                               f'data{os.sep}output{os.sep}unet_AFM_predictions9{os.sep}predict_sheets{os.sep}',
                               f'data{os.sep}output{os.sep}unet_AFM_predictions10{os.sep}predict_sheets{os.sep}'
                               ],
...
save_dict = {
            ...
            'Unet_AFM': [
                        f'Unet_AFM_1fold_metrics2.csv',
                        f'Unet_AFM_2fold_metrics2.csv',
                        f'Unet_AFM_3fold_metrics2.csv',
                        f'Unet_AFM_4fold_metrics2.csv',
                        f'Unet_AFM_5fold_metrics2.csv',
                        f'Unet_AFM_6fold_metrics2.csv',
                        f'Unet_AFM_7fold_metrics2.csv',
                        f'Unet_AFM_8fold_metrics2.csv',
                        f'Unet_AFM_9fold_metrics2.csv',
                        f'Unet_AFM_10fold_metrics2.csv',
                        ],
